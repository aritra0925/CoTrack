...
public class ServiceSpecificFragment extends Fragment {
    ...
    private void feedData() {
        ...
        int[] imageUrls = {R.drawable.hospital_icon, R.drawable.ambulance_icon, R.drawable.disinfect_icon, R.drawable.doctor_icon};
        String[] ProductName = {"Ruby Hospital", "Peerless", "Amri", "Beleghat Ide"};
